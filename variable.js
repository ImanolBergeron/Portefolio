const variable =[
    ...
    },
    {
        ...
        ProjectDescription:"RobotCup is a Symfony webapp to manage robot football championships. The website allows full management of the championship, from the creation "+
                            "of the championship to the management of the teams and the matches.</br></br>The idea is that a user registers his team on the website, then the public can "+
                            ...
                            " generate the full championship.</br></br> The organizer can also update the score of the match and the website will automatically update the ranking of the championship."+
                            "For example in a match between two "+
                            "teams, the organizer can update the goals of the blue team to 3 and set the victory to the blue team, which will be automatically updated in the ranking. </br></br>"+
...
variable.forEach(projet=>{
    if(projet.name === getCookie('projet')){
        ...
        EltDescription.innerHTML = projet.ProjectDescription;
        if(projet.Lien != ""){
